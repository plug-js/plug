...
describe('Source Maps', () => {
  ...
  it('should extract some source map data', () => {
    ...
    expect(extractSourceMap(file, files, `//# ${SOURCE_MAPPING_URL}=data:application/json;base64,eyJ2ZXJzaW9uIjozfQ\n// foobar`, false)).to.eql({
    ...
    expect(extractSourceMap(file, files, `//# ${SOURCE_MAPPING_URL}=baz.js.map\n// foobar`, false)).to.eql({
    ...
    expect(extractSourceMap(file, files, `//# ${SOURCE_MAPPING_URL}=\n// foobar`, false)).to.eql({
  ...
  describe('File based source maps', () => {
    ...
    it.skip('should properly attach sources to a FileSourceMap', () => {
      // const file = '/foo/bar.txt' as FilePath
    ...
    it.skip('should produce a simple source map', async () => {
    ...
    it.skip('should produce a combined source map', async () => {
    ...
    it.skip('should change paths when a file changes', async () => {
      // const { files } = mock('/foo')
